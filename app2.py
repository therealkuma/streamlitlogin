        ...
        def main():
            ...
            if expenses_file is not None and category_file is not None:
                ...
                if selected_category:
                    ...
                    categorized_df=categorized_df[~categorized_df['Category'].str.contains("Income", case=False, regex=True)]
                    categorized_df=categorized_df[~categorized_df['Description'].str.contains("CROSS|AUTOPAY|DIRECTPAY|AUTOMATIC", case=False, regex=True)]
                ...
                filtered_categorized_df_no_autopay = filtered_categorized_df[~filtered_categorized_df['Description'].str.contains("PAYMENT|AUTOPAY|DIRECTPAY", case=False, regex=True)]
                # filtered_categorized_df_no_autopay = categorized_df[categorized_df['Category'].str.lower() != 'card payment']
